...
import { TrendingUp, TrendingDown, ArrowLeft, Info, DollarSign, BarChart3, TrendingUp as Growth, FileText, Users } from 'lucide-react-native';
...
const CompanyOverview = () => (
  <View>
    <SectionTitle title="About Company" icon={<Info size={20} color="#6C5CE7" />} />
    <Text style={styles.descriptionText}>
      {/* Replace with actual company description */}
      Leading technology company specializing in consumer electronics, software, and services.
    </Text>
...
const FinancialMetrics = () => (
  <View>
    <SectionTitle title="Financial Metrics" icon={<DollarSign size={20} color="#6C5CE7" />} />
...
const FinancialStatements = () => {
  ...
  return (
    <View>
      <SectionTitle title="Financial Statements" icon={<FileText size={20} color="#6C5CE7" />} />
      ...
      {statementType === 'income' && (
        <View style={styles.statementTable}>
          <StatementRow title="Revenue" 
            values={['394.3B', '365.8B', '274.5B']} 
            growth={[7.8, 33.2]} 
          />
          <StatementRow title="Gross Profit" 
            values={['170.7B', '152.8B', '104.9B']} 
            growth={[11.7, 45.6]} 
          />
          <StatementRow title="Operating Income" 
            values={['119.4B', '108.9B', '66.3B']} 
            growth={[9.6, 64.2]} 
          />
          <StatementRow title="Net Income" 
...
const FinancialRatios = () => {
  return (
    <View>
      <SectionTitle title="Financial Ratios" icon={<BarChart3 size={20} color="#6C5CE7" />} />
...
const PeerComparison = () => {
  ...
  return (
    <View>
      <SectionTitle title="Peer Comparison" icon={<Users size={20} color="#6C5CE7" />} />
...
const TechnicalIndicators = () => (
  <View>
    <SectionTitle title="Technical Indicators" icon={<BarChart3 size={20} color="#6C5CE7" />} />
...
const StockNews = () => (
  <View>
    <SectionTitle title="Latest News" icon={<Growth size={20} color="#6C5CE7" />} />
...
const StatementRow: React.FC<StatementRowProps> = ({ title, values, growth }) => (
...
const PeerRow: React.FC<PeerRowProps> = ({ company, value, change, isHighest }) => (
